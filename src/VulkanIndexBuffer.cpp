...
namespace Vulk {
    ...
    void VulkanIndexBuffer::CopyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
    {
        VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
    ...
    VkCommandBuffer VulkanIndexBuffer::BeginSingleTimeCommands()
    {
    ...
    void VulkanIndexBuffer::EndSingleTimeCommands(VkCommandBuffer commandBuffer)
    {
